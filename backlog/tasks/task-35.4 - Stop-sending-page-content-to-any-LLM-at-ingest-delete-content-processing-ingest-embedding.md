...
- [ ] #2 The whole-page LanceDB embedding write at ingest is removed; ingestion writes nothing to LanceDB; semantic_search returns empty until task-31 builds the index (documented) — no interim embedding is added
...
- [ ] #5 Tests assert capture proceeds with no content-processing LLM call and no LanceDB write
<!-- AC:END -->
