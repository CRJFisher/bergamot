---
id: TASK-36.3
title: "Page vectorisation: TDT-owned embedding of captured pages"
status: To Do
assignee: []
...
- [ ] #1 build_page_vector reads a captured page and returns one L2-normalized vector via the injected EmbedFn, with no dependency on RAG chunk vectors or LanceDB
...
- [ ] #4 A determinism test shows the same capture plus a pinned model yields a bitwise-identical page vector regardless of fetch order
